 ...
 * to Sophisticated Core's own settings tabs -
 * {@link net.p3pp3rf1y.sophisticatedcore.settings.main.MainSettingsTab} (constructed through
 * {@link ContainerMainSettingsTab}), {@link NoSortSettingsTab}, {@link MemorySettingsTab} and
 * {@link ItemDisplaySettingsTab} - plus the {@link ContainerReturnTab} on top, mirroring how
 * {@code BackpackSettingsTabControl} maps backpacks' categories to the core tabs.
 */
public class ContainerSettingsTabControl extends StorageSettingsTabControlBase {
	...
	@Override
	protected <C extends net.p3pp3rf1y.sophisticatedcore.settings.SettingsContainerBase<?>, T extends net.p3pp3rf1y.sophisticatedcore.settings.SettingsTab<C>> ISettingsTabFactory<C, T> getSettingsTabFactory(String name) {
