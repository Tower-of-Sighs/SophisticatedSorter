 ...
 * <p>
 * Only {@link Level} APIs are used so the same code runs on
 * {@link net.minecraft.server.level.ServerLevel} and {@link net.minecraft.client.multiplayer.ClientLevel}.
 * 26.1 port of the shared {@code common/src/minecraft} resolver.
 */
