 ...
 * records the key of the container the player's menu was opened from (see
 * {@link ContainerSettingsTracker#onPlayerOpenMenu}), and the gate only applies to slots whose
 * container is not the player {@link Inventory} (main, armor, offhand).</li>
...
public final class ContainerMemorySlotGuard {
	 ...
	 * {@code ServerPlayer.doCloseContainer} tracking inject (the Fabric counterpart of the NeoForge
	 * container-close event listener the reference registers here).
	 */
